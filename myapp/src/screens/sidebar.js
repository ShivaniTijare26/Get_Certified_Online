...
import logo from '../ui/logo-1.png';
...
function Sidebar(){
    const[nav,setNav]=useState([
        ...
        {label:"ExamList",slug:"Examlist",icon:"icon-pencil"},
        {label:"Categories",slug:"Category",icon:"icon-book"},
        {label:"Courses",slug:"my-courses",icon:"icon-file-text"},
        {label:"Logout",slug:"Logout",icon:"icon-exit"}
    ])
    ...
    return(
        <div className='sidebar rel'>
            ...
            <div className="updated-course flex aic">
                <div className="icon-arrow-up cfff s18 ico" />
            ...
            <div className="stats aic flex">
                ...
                <div className="stats-box flex">
                    <div className="ico ico-points s24 icon-trophy" />
                    <h2 className="val s15 c333 fontb">1800</h2>
                    <h2 className="lbl s13 c777">points</h2>
                </div>

                <div className="stats-box flex">
                    <div className="ico ico-battery s24 icon-star-empty" />
